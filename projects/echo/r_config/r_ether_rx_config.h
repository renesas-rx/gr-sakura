...
/* PHY-LSI address setting for ETHER0/1.
 ...
 Please set the value 30 ETHER_CFG_CH0_PHY_ADDRESS when use default setting of the RSK+RX65N.
...
/* The register bus of PHY0/1 for ETHER0/1 select
 ...
 Please set the value 0 ETHER_CFG_CH0_PHY_ACCESS when use default setting of the RSK+RX65N.
